...
<head>
    ...
    <script>
        function redireccionar(valor) {
            ...
            if (valor === "1") {
                window.location.href = "TrianguloEstaticoSabo2.php"; // Reemplaza con la URL de tu primer formulario
            } 
        }
    </script>
</head>
...
<div class="paragraph-with-image">
                        ...
                        <<p class="card-text">PRIMERO VERIFICAR VERIFICAR EN MASTER QUE ZONA ES 
LA QUE REPORTA EL SABOTAJE</p> 
                        <br>                    
                    </div>                                                                                                        
...
<div class="paragraph-with-image">
                        ...
                        <p class="card-text">SEÑOR/A XXXXXXX EL DISPOSITIVO CON ERROR ES EL SIGUIENTE XXXXX, ESTA DISPUESTO A REALIZAR UNA VERIFICACION</p>
                        <br>                    
                    </div>                   
                        <div class="form-check">
