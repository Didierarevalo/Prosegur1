...
<head>
 ...
 <div class="contenedor5">
  ...
  <button class="boton-personalizado" type="button" onclick="window.location.href='TrianguloEstaticoSabo2.php'">Volver</button>
...
<div class="paragraph-with-image">
                        ...
                        <p class="card-text">SEÑOR/A XXXXXXX VERIFIQUE POR FAVOR QUE NO HAYA 
ALGUN OBJETO QUE PUEDA 
OBSTRUIR EL DISPOSITIVO, QUE ESTE 
BIEN TAPADO POR FAVOR</p> 
                        <br>                    
                    </div>                                                                                                        
...
<div class="paragraph-with-image">
                        <img src="Imagenes/asesor.png" alt="">
                        <p class="card-text">SEÑOR/A XXXXXXX POR FAVOR VERIFICAR SI HAY CABLES DEL DISPOSITIVO QUE A SIMPLE VISTA SE VEAN DETERIORADOS O EN MAL ESTADO 
</p>
                        <br>                    
                    </div>                   
                        <div class="form-check">
