...
<head>
 ...
 <div class="contenedor5">
  ...
  <h1 class="titulo">FALLO</h1>
</div>
 <p class="PNeo"><b>¿SE ARREGLO EL 
FALLO Y TODO 
CONTINUO BIEN?</p></b>
...
<div class="paragraph-with-image">
                    ...
                    <div class="form-check">
                        <button type="button" class="btn btn-primary" onclick="redireccionar('1'); enviarMensaje9(); ">Continuar</button> 
                        </div>
                        <script>
        function enviarMensaje9() {
            var mensaje = "El cliente ha contactado para notificar un fallo. En respuesta, se le ha sugerido que inspeccione el dispositivo en cuestión para asegurarse de que no esté obstruido ni experimente interferencias, así como verificar que esté correctamente tapado. Tras realizar estas verificaciones, el cliente ha logrado resolver satisfactoriamente el problema.";
...
<div class="paragraph-with-image">
                        ...
                        <p class="card-text">SEÑOR/A XXXXXXX NECESITAMOS REALIZAR EL BYPASS DE LA ZONA PARA PODER GENERAR EL PROCESO DE ARMADO, POR FAVOR SIGA LOS SIGUIENTES PASOS A CONTINUACION
</p>
</p>
                        <br>                    
                    </div>                   
            ...
            <button class="boton-personalizado" type="button" onclick="window.location.href='TrianguloEstaticoSabo3.php'">Volver</button>
