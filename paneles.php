...
<head>
    ...
    <script>
        function redireccionar(valor) {
            ...
            if (valor === "1") {
                window.location.href = "FallasNEO.php"; // Reemplaza con la URL de tu primer formulario
            } else if (valor === "2") {
...
<div class="paragraph-with-image">
    ...
    <div class="paragraph-with-image">
        <img src="Imagenes/asesor.png" alt="">
        <p><b>-SEÑOR/A XXXXXX SE PODRIA ACERCARSE AL TECLADO POR FAVOR</p></b>
    </div>
