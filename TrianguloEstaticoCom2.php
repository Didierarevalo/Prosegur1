...
<div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-3 ">
                    <div class="card-body">
                        <h5 class="card-title">VERIFICACION DE SEÑAL</h5>
...
INSTALADA<BR><BR>INGRESAR A PLATAFORMA KITE Y PEGAR
EL NUMERO DE TELEFONO , LUEGO
INGRESAR EN LA SIM Y DARLE CLICK EN
LANZAR PRUEBA PARA VERIFICAR SEÑAL</p> 
                        <br>                    
                    </div>                                                                                                        
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title">CUANDO HAY FALLO CON INTERNET</h5>
                        
<div class="paragraph-with-image">
                        <img src="Imagenes/asesor.png" alt="">
                        <p class="card-text">SEÑOR/A XXXXXXX RECUERDE QUE DEBE
TENER INTERNET Y QUE EL CABLE ESTE BIEN
CONECTADO PARA QUE NO GENERE ESTE
TIPO DE FALLO
<BR><BR><B>SOLO CUANDO HAY DOBLE MEDIO<B>
</p>
                        <br>                    
                    </div>                   
                    <div class="form-check">
