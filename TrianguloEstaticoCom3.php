...
<head>
    ...
    <script>
        function redireccionar(valor) {
            ...
            if (valor === "1") {
                window.location.href = "TrianguloEstaticoCom4.php"; // Reemplaza con la URL de tu primer formulario
            } else if (valor === "2") {
 ...
 <p class="PNeo"><b>¿LUEGO DE REINICIAR LA TL SE REESTABLECIO COMUNICACION?</p></b>

 <div class="paragraph-with-image">
                        <img src="Imagenes/procedimiento.png" alt="">
                        <p class="card-text"><b>INGRESAR PRIMERO A
PRUEBAS DESDE MASTERMIND PARA
VERIFICAR EL SISTEMA</b></p> 
                        <br>                    
                    </div>
                    
                    <div class="paragraph-with-image">
                        <img src="Imagenes/procedimiento.png" alt="">
                        <p class="card-text"><b>RECUERDA REALIZAR LA VERIFICACIÓN DE SEÑALES EN MASTERMIND</b></p> 
                        <br>                    
                    </div>
...
<div class="paragraph-with-image">
                        ...
                        <p class="card-text">SEÑOR/A XXXXXXX POR FAVOR ENVIE
EVENTOS DE MEDICAS (CRUCES) POR
6 SEGUNDOS Y 6 SEGUNDOS DE
PANICO(ESCUDO POLICIA) PARA
COMPROBAR COMUNICACION</p> 
                        <br>                    
                    </div>                                                                                                        
...
VISITA EN SIEBEL
<br><br><B>RECUERDE LA TIPIFICACIÓN ES REPARACION + MANTENIMIENTO</B>
</p>
                        <br>                    
                    </div>                   
                    <div class="form-check">
            ...
            <button class="boton-personalizado" type="button" onclick="window.location.href='TrianguloEstaticoCom1.php'">Volver</button>
