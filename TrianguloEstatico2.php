...
<head>
 ...
 <p class="PNeo"><b>¿Se confirma envio de correo con solicitud de cambio de contraseña?</p></b>
...
DANDO LA COMUNICACION POR LOS 
DOS MEDIOS (GPRS-ETHERNET)</p>                                                                                                       
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">REVISAR CONEXION DEL CABLE DE RED 
AL ROUTER DEL CLIENTE Y QUE EL 
INTERNET FUNCIONE CORRECTAMENTE</p>
