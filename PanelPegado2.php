...
<head>
    ...
    <script>
        function redireccionar(valor) {
            ...
            if (valor === "1") {
                window.location.href = "PanelPegado4.php"; // Reemplaza con la URL de tu primer formulario
            } else if (valor === "2") {
                window.location.href = "PanelPegado3.php"; // Reemplaza con la URL de tu segundo formulario
            } else if (valor === "3") {
                window.location.href = "PanelPegado3.php"; // Reemplaza con la URL de tu segundo formulario
            } 
            else if (valor === "4") {
...
<div class="contenedor5">
 ...
 <div class="paragraph-with-image">
        ...
        <p><b><br><br>¿QUE ZONA TIPO DE ZONA GENERA EL ERROR?</p></b>
    </div>     
...
<div class="paragraph-with-image">
                        ...
                        <p class="card-text">SEÑOR/A XXXX POR FAVOR DIGITE SU CLAVE Y SIGA MIS INDICACIONES A CONTINUACION YA QUE DEBEMOS ANULAR LA ZONA</p> 
                        <br>                    
                    </div>
            ...
            <div class="col-md-6">
                <div class="card mb-3 ">
                    <div class="card-body">
                        <h5 class="card-title">Panico</h5>
                        

<div class="paragraph-with-image">
                        <img src="Imagenes/asesor.png" alt="">
                        <p class="card-text">SEÑOR/A XXXXX, POR FAVOR VERIFICAR SI EL BOTON ESTA ATASCADO, HAY PANICOS QUE LLEVAN UNA LLAVE PARA RESTAURARLOS CUANDO FUERON OBTURADOS, SI CUENTA CON LA LLAVE POR FAVOR UTILICELA   </p> 
                        <br>                    
                    </div>
                        <div class="form-check">
                ...
                <div class="card mb-3 ">
                    <div class="card-body">
                        <h5 class="card-title">Puerta de emergencia</h5>
                        

<div class="paragraph-with-image">
                        <img src="Imagenes/asesor.png" alt="">
                        <p class="card-text">SEÑOR/A XXXXXX LA PUERTA QUE NOS GENERA ERROR ES XXXXX POR FAVOR VERIFICAR QUE LA PUERTA ESTE AJUSTADA CORRECTAMENTE </p> 
                        <br>                    
                    </div>
                        <div class="form-check">
