...
<head>
 ...
 <div class="contenedor5">
  ...
  <h1 class="titulo">CLAVE SMART</h1>
</div>
 <div class="paragraph-with-image">
        <img src="Imagenes/asesor.png" alt="">
        <p><b>-PUEDE POR FAVOR INGRESAR EL CORREO Y CONTRASEÑA EN EL APLICATIVO SMART</p></b>
    </div> 
...
<div class="paragraph-with-image">
                        <img src="Imagenes/asesor.png" alt="">
                        <p class="card-text">AL INGRESAR AL APLICATIVO EN LA PARTE SUPERIOR A LA IZQUIERDA HAY UN MENU LATERAL OPRIMIR MI ALARMA, LUEGO LA SUBSECCION CODIGOS DE TECLADO</p> 
                        <br>                    
                    </div>                                                                                                        
...
<div class="paragraph-with-image">
                        <img src="Imagenes/asesor.png" alt="">
                        <p class="card-text">EN PANTALLA PUEDE CONSULTAR Y EDITAR LOS CODIGOS DE TECLADO ASOCIADOS A CADA USUARIO , DIRIJASE AL USUARIO QUE QUIERA CAMBIAR LA CLAVE Y EN EL LAPIZ QUE SALE A LA DERECHA OPRIMIR Y EDITAR EL CODIGO PARA HACER SU RESPECTIVO CAMBIO</p>
                        <br>                    
                    </div>                   
                        <div class="form-check">
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="paragraph-with-image">
                        <img src="Imagenes/asesor.png" alt="">
                        <p class="card-text">POR ULTIMO SEÑOR/A XXXXXXX VAMOS A REALIZAR UNA CONFIRMACION DEL PROCESO, POR FAVOR OPRIMIR EL * LUEGO EL NUMERO 1 EN PANTALLA SALDRA DIGITE TAG O CODIGO , AHI DEBES PONER LA CLAVE QUE SE LE HIZO EL CAMBIO SI TE DEJA ACCEDER AL MENU ES POR QUE LA CLAVE SE CAMBIO CORRECTAMENTE</p>
                        <br>                    
                    </div>
                    <div class="form-check">
    ...
    function enviarMensaje3() {
        ...
        window.location.href = "Observaciones.php?mensaje=" + encodeURIComponent(mensaje);
            ...
            <div class="centrar-imagen container">
            <img src="imagenes/smrt.png"width="150px" height="210PX">  
            <img src="imagenes/smart1.png"width="150px" height="210PX">
            <br><br>
<img src="imagenes/smart.png"width="150px" height="210PX">  
    </div>
